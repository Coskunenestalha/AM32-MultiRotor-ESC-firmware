...
uint16_t startup_max_duty_cycle = 750 + DEAD_TIME;
...
void loadEEpromSettings(){
	 ...
	 //	 min_startup_duty = sin_mode_min_s_d;
      ...
      motor_poles = eepromBuffer[27];
	   ...
	   min_startup_duty = 750+ dead_time_override;
